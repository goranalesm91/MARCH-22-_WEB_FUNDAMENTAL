...
fetch('https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics%2Cplayer&id='+video_id+'&key=AIzaSyBeADFcGCeJEAOPoLSojJ4E_Mzn63W9dxQ')
.then((res) => {
  return res.json();
}).then((data) => {
